...
let roughEle;
function createElement(id, x1, y1, x2, y2, toolType) {
  ...
  return (
    <div>
      <div className="buttons">
        <button onClick={() => setToolType("pencil")}>pencil</button>
        <button onClick={() => setToolType("line")}>line</button>
        <button onClick={() => setToolType("rectangle")}>rectangle</button>
        <button onClick={() => setToolType("circle")}>circle</button>
        <button
          onClick={() => {
            setPath([]), setElements([]);
          }}
